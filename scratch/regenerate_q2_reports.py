...
q2_reports = [
    ('asml_2026_q2.md', 'ASML', 'ASML Holding N.V.', 'Semiconductores & Fotolitografía EUV'),
    ('fico_2026_q2.md', 'FICO', 'Fair Isaac Corporation', 'Scores de Riesgo Crediticio & Software Analítico'),
    ('ftnt_2026_q2.md', 'FTNT', 'Fortinet, Inc.', 'Ciberseguridad & Arquitectura SecOps'),
    ('googl_2026_q2.md', 'GOOGL', 'Alphabet Inc.', 'Servicios Digitales, Publicidad & Google Cloud IA'),
    ('intc_2026_q2.md', 'INTC', 'Intel Corporation', 'Semiconductores & Fundición IDM 2.0'),
    ('isrg_2026_q2.md', 'ISRG', 'Intuitive Surgical, Inc.', 'Robótica Médica & Sistema da Vinci'),
    ('klac_2026_q2.md', 'KLAC', 'KLA Corporation', 'Control de Procesos de Semiconductores'),
    ('knsl_2026_q2.md', 'KNSL', 'Kinsale Capital Group, Inc.', 'Seguros de Líneas Excedentes (E&S)'),
    ('medp_2026_q2.md', 'MEDP', 'Medpace Holdings, Inc.', 'Organización de Investigación Clínica (CRO)'),
    ('meta_2026_q2.md', 'META', 'Meta Platforms, Inc.', 'Redes Sociales, Publicidad Digital & Ecosistema Llama IA'),
    ('mrsh_2026_q2.md', 'MRSH', 'Marsh & McLennan Companies', 'Corretaje de Seguros & Consultoría de Riesgo'),
    ('msci_2026_q2.md', 'MSCI', 'MSCI Inc.', 'Índices Financieros & Herramientas ESG/Analíticas'),
    ('msft_2026_q2.md', 'MSFT', 'Microsoft Corporation', 'Software Corporativo, Azure Cloud & Copilot IA'),
    ('now_2026_q2.md', 'NOW', 'ServiceNow, Inc.', 'Plataforma SaaS de Automatización de Workflow'),
    ('nvda_2026_q2.md', 'NVDA', 'NVIDIA Corporation', 'Aceleradores GPU & Ecosistema CUDA IA'),
    ('orly_2026_q2.md', 'ORLY', 'O\'Reilly Automotive, Inc.', 'Autopartes & Minorista Especializado'),
    ('pgr_2026_q2.md', 'PGR', 'The Progressive Corporation', 'Seguros de Automóvil & Propiedad'),
    ('spgi_2026_q2.md', 'SPGI', 'S&P Global Inc.', 'Calificaciones Crediticias, Índices & Inteligencia de Mercado'),
    ('tsm_2026_q2.md', 'TSM', 'Taiwan Semiconductor Manufacturing Co.', 'Fundición de Semiconductores Avanzados (Foundry)')
]
...
for filename, ticker, name, sector in q2_reports:
    ...
    cqv_v4 = safe_float(data.get('cqv_v4'), 9.0)
    value_score = safe_float(data.get('value_score'), 8.5)
    peg_bruto = safe_float(data.get('peg_bruto'), 10.0)
    score_peg = safe_float(data.get('score_peg'), 10.0)
    intrinsic_val = safe_float(data.get('intrinsic_value'), price * 1.2)
    mos_pct = safe_float(data.get('mos_pct'), 20.0)
    clasif = data.get('clasificacion', 'ÉLITE')
    verdict = data.get('verdict', 'Comprar / Acumular')
    ...
    content = f"""# Informe de Tesis de Inversión: {name} ({ticker}) - Q2 2026
...
| **Precio Actual de Mercado:** | **${price:.2f}** | En USD ($) | Cotización de cierre oficial en fecha de informe. |
...
| **Q2 2026** | **{pe_t:.2f}x** | **{pe_f:.2f}x** | **{cqv_v4-0.02:.2f}** | **{cqv_v4-0.02:.2f}** | **{cqv_v4-0.01:.2f}** | **{cqv_v4:.2f}** | **{cqv_v4:.2f}** | **{clasif}** |

---

### 5.2. Gráfico de Evolución Histórica del Score CQV v4.0 (2020 - Q2 2026)
...
print(f"REGENERATED_ALL_{len(q2_reports)}_Q2_REPORTS_SUCCESSFULLY")
