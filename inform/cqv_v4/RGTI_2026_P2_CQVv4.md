...
```mermaid
graph TD
    Sub1["RGTI (Rigetti Computing)"] --- Leader1["Arquitectura Superconductora & Fab-1 Propia"]
    Sub2["IONQ (IonQ, Inc.)"] --- Leader2["Arquitectura de Iones Atrapados (Trapped-Ion)"]
    Sub3["IBM (IBM Quantum)"] --- Leader3["Líder Global en Cúbits Superconductores de Gran Escala"]
```
