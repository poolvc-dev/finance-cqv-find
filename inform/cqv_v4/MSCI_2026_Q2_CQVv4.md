...
```mermaid
graph TD
    Sub1["MSCI (MSCI Inc.)"] --- Leader1["Líder Global en Índices de Referencia & Analítica de Mercado"]
    Sub2["SPGI (S&P Global / FTSE)"] --- Leader2["Competidor en Índices Accionarios & Datos de Mercado"]
    Sub3["MCO (Moody's Analytics)"] --- Leader3["Competidor en Modelos de Riesgo & Datos Financieros"]
    Sub4["LSEG (FTSE Russell)"] --- Leader4["Competidor en Índices Bursátiles Globales"]
```
