...
```mermaid
graph TD
    Sub1["UBER"] --- Leader1["Líder Global en Mobility & Delivery Platform"]
    Sub2["LYFT"] --- Leader2["Rival Regional Mobility US/Canada"]
    Sub3["DASH (DoorDash)"] --- Leader3["Líder US Food Delivery"]
    Sub4["GRAB / SE"] --- Leader4["Líderes Regionales LatAm / Asia"]
```
