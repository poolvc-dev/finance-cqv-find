# Informe de Tesis de Inversión: IonQ, Inc. (IONQ) - Q2 2026
...
```mermaid
graph TD
    Sub1["IONQ (IonQ, Inc.)"] --- Leader1["Líder Comercial en Iones Atrapados ($AQ 35$)"]
    Sub2["RGTI (Rigetti Computing)"] --- Leader2["Arquitectura Superconductora Modulares"]
    Sub3["HON / Quantinuum"] --- Leader3["Competidor en Iones Atrapados de Alta Fidelidad"]
```
