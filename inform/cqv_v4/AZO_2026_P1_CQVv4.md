...
```mermaid
graph TD
    Sub1[AZO] --- Leader1[Monopolio #1 en Aftermarket Automotriz con 7,856 Tiendas en América del Norte]
    Sub2[O'Reilly / ORLY] --- Leader2[Competidor #2 en Autopartes, Orientado al Segmento DIY-Comercial]
    Sub3[Advance Auto Parts / AAP] --- Leader3[Competidor #3 en Reestructuración Operativa]
```
