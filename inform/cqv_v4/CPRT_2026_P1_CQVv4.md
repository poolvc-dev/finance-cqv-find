...
```mermaid
graph TD
    Sub1[CPRT] --- Leader1[Líder Mundial en Subastas de Salvamento con Red de Patios Inmobiliarios Propietarios]
    Sub2[IAA / Ritchie Bros] --- Leader2[Competidor Secundario en Subastas de Vehículos y Maquinaria]
    Sub3[Auto1 / KAR Global] --- Leader3[Competidores en Remarketing de Vehículos Usados y Flotas]
```
