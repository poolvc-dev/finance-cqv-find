...
```mermaid
graph TD
    Sub1[EPAM] --- Leader1[Líder en Ingeniería de Software Complejo y Soluciones Digitales de IA]
    Sub2[Globant] --- Leader2[Competidor en Transformación Digital e Inteligencia Artificial]
    Sub3[Accenture / Endava] --- Leader3[Competidores en Consultoría de TI e Integración de Sistemas]
```
