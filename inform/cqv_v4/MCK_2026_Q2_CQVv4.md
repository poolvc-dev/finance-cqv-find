# Informe de Tesis de Inversión: McKesson Corporation (MCK) - Q2 2026
...
```mermaid
graph TD
    Sub1["MCK (McKesson)"] --- Leader1["Líder en Distribución Farmacéutica & Red Oncología US"]
    Sub2["COR (Cencora)"] --- Leader2["Distribución Farmacéutica Especializada & Europa"]
    Sub3["CAH (Cardinal Health)"] --- Leader3["Distribución de Medicamentos & Productos Médicos"]
```
