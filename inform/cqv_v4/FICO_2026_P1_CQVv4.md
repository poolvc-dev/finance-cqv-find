...
```mermaid
graph TD
    Sub1["FICO"] --- Leader1["Monopolio en Puntuación Crediticia (FICO Score)"]
    Sub2["VantageScore"] --- Leader2["Competidor Principal en el Segmento"]
    Sub3["Experian / Equifax Direct"] --- Leader3["Competidor Secundario en el Segmento"]
```
