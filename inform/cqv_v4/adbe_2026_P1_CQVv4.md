...
```mermaid
graph TD
    Sub1["ADBE"] --- Leader1["Estándar de la Industria Creativa (Photoshop, Illustrator, Acrobat)"]
    Sub2["Figma / Canva"] --- Leader2["Competidor Principal en el Segmento"]
    Sub3["Salesforce Marketing Cloud"] --- Leader3["Competidor Secundario en el Segmento"]
```
