...
```mermaid
graph TD
    Sub1["PWR (Quanta Services)"] --- Leader1["Líder Absoluto en Infraestructura de Red Eléctrica & Energías Limpias"]
    Sub2["EME (EMCOR Group)"] --- Leader2["Líder en Servicios Eléctricos y Mecánicos Industriales"]
    Sub3["MTZ (MasTec)"] --- Leader3["Competidor en Telecom, Oleoductos y Renovables"]
    Sub4["MYRG (MYR Group)"] --- Leader4["Competidor Especializado en Transmisión Eléctrica"]
```
