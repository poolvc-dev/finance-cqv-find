...
```mermaid
graph TD
    Sub1["[TICKER]"] --- Leader1["Líder en [Área de Dominio / Producto Principal]"]
    Sub2["[Competidor 1]"] --- Leader2["Competidor en [Mercado Relacionado]"]
    Sub3["[Competidor 2]"] --- Leader3["Competidor en [Software / Servicios]"]
```
