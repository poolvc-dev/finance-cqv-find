# Informe de Tesis de Inversión: VanEck Semiconductor ETF (SMH) — P2 2026 (Q2 2026)
...
CQV Calidad:             9.59 / 10
Value Score:             7.89 / 10
Valor intrínseco base:   325.00
Valor intrínseco esperado: $315.25 (MoS 15.64%)
Precio usado:            268.50
Veredicto:               Acumular
```
...
| Score margen de seguridad | 5.79 / 10 | SSOT |
| **Value Score** | **7.89 / 10** | cálculo SSOT; reponderado si falta un componente |
...
| :--- | ---: | :--- |
| Valor intrínseco base | 325.00 | SSOT |
| MoS base | 17.38% | SSOT |
| Valor esperado | 315.25 | SSOT |
| MoS esperado | 15.64% | SSOT |
