...
CQV Calidad:             9.63 / 10
Value Score:             8.34 / 10
Valor intrínseco base:   1,031.25
Valor intrínseco esperado: $1,000.31 (MoS 18.00%)
Precio usado:            825.00
Veredicto:               Acumular
```
...
| **CQV total** | **9.63** | **100%** | **9.63** | **COHERENTE con SSOT** |

## 3. Datos financieros, fecha y fuentes

| Dato | Valor | Tipo | Fuente / limitación |
| :--- | ---: | :--- | :--- |
| Precio | 825.00 | dato de mercado | Fecha SSOT: 29/07/2026; proveedor N/D |
...
| :--- | ---: | :--- |
| Valor intrínseco base | 1,031.25 | SSOT |
| MoS base | 20.00% | SSOT |
| Valor esperado | 1,000.31 | SSOT |
