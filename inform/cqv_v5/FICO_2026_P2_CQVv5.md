...
CQV Calidad:             9.68 / 10
Value Score:             5.76 / 10
Valor intrínseco base:   2,225.00
Valor intrínseco esperado: $2,158.25 (MoS 18.00%)
Precio usado:            1,780.00
Veredicto:               Acumular
```
...
| :--- | ---: | :--- | :--- |
| Precio | 1,780.00 | dato de mercado | Fecha SSOT: 29/07/2026; proveedor N/D |
| Capitalización | 31,840.00 | dato derivado / mercado | Fuente primaria N/D |
...
| Score crecimiento/múltiplo | 4.85 / 10 | SSOT |
| Score margen de seguridad | 6.67 / 10 | SSOT |
| **Value Score** | **5.76 / 10** | cálculo SSOT; reponderado si falta un componente |
...
| :--- | ---: | :--- |
| Valor intrínseco base | 2,225.00 | SSOT |
| MoS base | 20.00% | SSOT |
| Valor esperado | 2,158.25 | SSOT |
