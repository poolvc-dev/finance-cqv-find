...
CQV Calidad:             9.65 / 10
Value Score:             6.37 / 10
Valor intrínseco base:   544.00
Valor intrínseco esperado: $527.68 (MoS 18.00%)
Precio usado:            435.20
Veredicto:               Acumular
```
...
| :--- | ---: | ---: | ---: | :--- |
| F1 | 9.75 | 20% | 1.95 | Evidencia bruta y percentil: N/D en SSOT |
...
| Score crecimiento/múltiplo | 6.07 / 10 | SSOT |
| Score margen de seguridad | 6.67 / 10 | SSOT |
| **Value Score** | **6.37 / 10** | cálculo SSOT; reponderado si falta un componente |
...
| :--- | ---: | :--- |
| Valor intrínseco base | 544.00 | SSOT |
| MoS base | 20.00% | SSOT |
| Valor esperado | 527.68 | SSOT |
