...
CQV Calidad:             9.60 / 10
Value Score:             7.62 / 10
Valor intrínseco base:   340.63
Valor intrínseco esperado: $330.41 (MoS 18.00%)
Precio usado:            272.50
Veredicto:               Acumular
```
...
| **CQV total** | **9.60** | **100%** | **9.60** | **COHERENTE con SSOT** |

## 3. Datos financieros, fecha y fuentes

| Dato | Valor | Tipo | Fuente / limitación |
| :--- | ---: | :--- | :--- |
| Precio | 272.50 | dato de mercado | Fecha SSOT: 29/07/2026; proveedor N/D |
...
| Score crecimiento/múltiplo | 8.58 / 10 | SSOT |
| Score margen de seguridad | 6.67 / 10 | SSOT |
| **Value Score** | **7.62 / 10** | cálculo SSOT; reponderado si falta un componente |
...
| :--- | ---: | :--- |
| Valor intrínseco base | 340.63 | SSOT |
| MoS base | 20.00% | SSOT |
| Valor esperado | 330.41 | SSOT |
...
| :--- | :---: | :---: | :---: | :---: | :---: |
| **2020 (Mediana)** | 20.2x | 16.8x | 9.21 | 9.21 | ÉLITE |
| **2021 (Mediana)** | 24.7x | 20.6x | 9.38 | 9.38 | ÉLITE |
| **2022 (Mediana)** | 18.2x | 15.2x | 9.16 | 9.16 | ÉLITE |
| **2023 (Mediana)** | 23.0x | 19.2x | 9.38 | 9.38 | ÉLITE |
| **2024 (Mediana)** | 25.9x | 21.6x | 9.52 | 9.52 | ÉLITE SUPREMA |
| **2025 (Mediana)** | 27.0x | 22.5x | 9.58 | 9.58 | ÉLITE SUPREMA |
| **P1 2026** | 27.2x | 22.7x | 9.53 | 9.53 | ÉLITE SUPREMA |
| **P2 2026** | **27.8x** | **23.2x** | **9.60** | **9.60** | **ÉLITE SUPREMA** |
