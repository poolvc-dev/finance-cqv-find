# Informe de Tesis de Inversión: Fair Isaac Corporation (FICO) - Q3 FY26 (Q2 26)
**Fecha de Emisión:** 29 de Julio de 2026 (Post-Resultados de Q3 FY26 (Q2 26))  
...
| **Value Score (Capa de Valoración):** | **7.03 / 10** | 0.00 – 10.00 | **Atractivo** |
| **PEG Bruto (EPS Growth / PER Fwd * 10):** | **7.15** | Sin acotación | Métrica auditada bruta de crecimiento vs múltiplo. |
| **Score PEG Normalizado:** | **7.15 / 10** | 0.00 – 10.00 | Métrica acotada para cálculo de Value Score. |
...
Fair Isaac Corporation (FICO) opera en el sector de Technology. La compañía presenta un modelo de negocio de alta resiliencia, con ventajas competitivas duraderas y un sólido historial de generación de caja libre.

En el **segundo trimestre de 2026 (Q3 FY26 (Q2 26))**, la compañía reportó sólidas métricas operativas con expansión de márgenes y disciplina en la asignación de capital. Con la cotización actual a **$1373.08**, el múltiplo PER Trailing se ubica en **42.38x** y el PER Forward en **25.17x**, ofreciendo un margen de seguridad del **33.8%** frente a su valor intrínseco de **$2075.00**.
...
## 3. Análisis Detallado del Estado de Resultados (Q3 FY26 (Q2 26))
...
| Métrica de Eficiencia de Capital | 2020 | 2021 | 2022 | 2023 | 2024 | 2025 | Q3 FY26 (Q2 26) TTM | Tendencia y Diagnóstico (Desde 2020) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
...
Con la acción cotizando actualmente a **$1373.08** (PER Trailing: **42.38x**, PER Forward: **25.17x**), se desglosa el **Value Score (7.03)**, el **PEG Bruto (7.15)** y el **Score PEG Normalizado (7.15/10)**:

$$\text{Value Score} = 0.40(\text{Score FCF Yield}) + 0.30(\text{Score PEG}) + 0.30(\text{Score Margen de Seguridad})$$

$$\text{PEG Bruto} = \left(\frac{\text{Crecimiento EPS NTM (%)}}{\text{PER Forward}}\right) \times 10 = \mathbf{7.15} \implies \text{Score PEG Normalizado} = \mathbf{7.15 / 10}$$

### 🟢 Nivel 1: Zona de Entrada Excelente ($1304.43 - $1441.73) — Entrando actualmente
### 🟡 Nivel 2: Zona de Precio Ideal / Gran Oportunidad ($1098.46 - $1290.70)
### 🔴 Nivel 3: Zona de Ganga / Pánico de Mercado (< $1098.46)
...
Fair Isaac Corporation (FICO) se consolida como una compañía de destacada calidad fundamental. Con un modelo de negocio resiliente, alta rentabilidad sobre capital invertido y una puntuación de **CQV Calidad v4.0 de 9.62/10**, la acción presenta un margen de seguridad del **33.8%**.
